    ...
    <div>
      <div className="report-content">
        <div className="feedback-header">
          <h5 className="report-title">Help & Feedback</h5>
          <p>
        ...
        <div className={`feedback-container ${next ? "d-none" : ""}`}>
          <div
            ...
            onClick={() => setActive("product offer")}
          >
            Wider product offers
          </div>
          <div
            className={`feedback-button ${
              active === "Better insurance services" ? "active" : ""
            }`}
            onClick={() => setActive("Better insurance services")}
          >
            Better insurance services
          </div>
          <div
            className={`feedback-button ${
              active === "Easier registration process" ? "active" : ""
            }`}
            onClick={() => setActive("Easier registration process")}
          >
            Easier registration process
          </div>
          <div
            className={`feedback-button ${
              active === "Easier registration processs" ? "active" : ""
            }`}
            onClick={() => setActive("Easier registration processs")}
          >
            Easier registration process
          </div>
          <div
            className={` ${active === "" ? "feedback-next" : "activebutton"}`}
          >
            <button
